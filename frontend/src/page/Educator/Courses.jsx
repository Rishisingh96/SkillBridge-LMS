          ...
          <table className="w-full min-w-[700px]">
            ...
            <tbody>
              <tr className="border-t hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        Learn modern UI/UX design from scratch
                      </p>
                    </div>
                  </div>
                </td>
                ...
                {/* Action */}
                <td className="px-6 py-5">
                  <button className="w-10 h-10 rounded-lg bg-gray-100 hover:bg-black hover:text-white transition flex items-center justify-center">
      ...
      <div className="md:hidden space-y-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 mt-1 line-clamp-2">
                Learn modern UI/UX design from scratch with practical projects.
              </p>
          ...
          <div className="flex items-center justify-between mt-5 pt-4 border-t">
            ...
            <button className="flex items-center gap-2 bg-black text-white px-4 py-2 rounded-xl text-sm hover:scale-105 transition">
              <FaEdit />
              Edit Course
            </button>
          </div>
