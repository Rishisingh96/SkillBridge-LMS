...
const SignUp = () => {
  ...
  return (
    <div className="bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center">
      <form className="w-[90%] md:w-[500px] lg:w-[600px] h-auto md:h-[550px] lg:h-[600px] bg-[white] shadow-xl rounded-2xl flex flex-col md:flex-row" onSubmit={(e)=>e.preventDefault()}>
        ...
        <div className="w-[100%] md:w-[50%] h-[100%] flex flex-col items-center justify-center gap-3 p-4 md:p-0">
          ...
          <div className="flex md:w-[50%] w-[70%] items-center justify-between">
            ...
            <span className={`px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-xl cursor-pointer hover:border-black ${role === "student" ? "border-black":"border-[#646464]"}`} 
            onClick={()=>setRole("student")}
            >
              Student
            </span>
            <span className={`px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-xl cursor-pointer hover:border-black ${role === "educator" ? "border-black":"border-[#646464]"}`} 
          ...
          {/* SignUp */}
          <button className="w-[90%] md:w-[80%] h-[40px] md:h-[45px] bg-black text-white cursor-pointer flex items-center justify-center rounded-[5px]" onClick={handleSignup} disabled={loading}>
          ...
          <div className="flex items-center justify-center mt-2" onClick={googleSignUp}>
            <img
          ...
          <div className="text-[#6f6f6f] text-sm md:text-base">
